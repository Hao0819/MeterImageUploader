...
//     const USABLE_W = GREETING_W - 8;
//     const USABLE_H = GREETING_H - 8;

//     // ← Raise minimums: hardware screen needs ≥13px to render strokes clearly
//     const MIN_FONT = hasChinese ? 14 : 13;

//     let fontSize, lineHeight;

//     if (hasArabic) {
//         if (n > 100) fontSize = 13;
//         else if (n > 80) fontSize = 14;
//         else if (n > 60) fontSize = 15;
//         else if (n > 40) fontSize = 17;
//         else if (n > 20) fontSize = 20;
//         else if (n > 10) fontSize = 23;
//         else fontSize = 27;
//         lineHeight = Math.round(fontSize * 1.35);
//     } else {
//         // ← For Chinese: full-width chars need ratio 1.05 to avoid underestimating
//         // ← For English: 0.55 accounts for mixed wide/narrow chars like W, M
//         const charWidthRatio = hasChinese ? 1.05 : 0.55;
//         const sizes = [28, 26, 24, 22, 20, 18, 17, 16, 15, 14, 13];
//         fontSize = MIN_FONT;
//         lineHeight = Math.round(MIN_FONT * 1.4);

//         for (const fs of sizes) {
//             if (fs < MIN_FONT) break; // ← never go below hardware minimum
//             const lh = Math.round(fs * 1.4); // ← 1.4 gives clear line separation
...
//         color: 'black',
//         textAlign: 'center',
//         fontWeight: '700',   // ← Key fix: bold strokes survive low-res screens
//         flexWrap: 'wrap',
//         flexShrink: 1,
//     },
//     rtlText: {
